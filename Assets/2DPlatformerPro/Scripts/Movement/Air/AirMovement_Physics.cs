...
namespace PlatformerPro
{
	...
	public class AirMovement_Physics : AirMovement, IPhysicsMovement
	{
...
#if UNITY_EDITOR
			else if (movementData != null && movementData.Length == MovementVariableCount - 1)
			{
		...
		public static MovementVariable[] DrawInspector(MovementVariable[] movementData, ref bool showDetails, Character target)
		{
			...
			{
				Debug.LogWarning("Trying to automatically update AitMovement Physics movement data. Double check the new values.");
